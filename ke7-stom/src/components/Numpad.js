...
const Numpad = (props) => {
  ...
  const { baseColor, insideBaseColor, keyColor, keyOtherColor } =
    useCustomization();
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        geometry={nodes.Keys1.geometry}
        material={materials.Keys1}
        position={[-0.684, 0.342, -0.633]}
        scale={0.215}
      >
        <meshStandardMaterial color={keyColor.color} />
      </mesh>
      <mesh
        geometry={nodes.Keys2.geometry}
