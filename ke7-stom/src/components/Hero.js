...
function Hero(props) {
  ...
  function onDocumentMouseMove(event) {
    mouseX =
      event.movementX * 0.5 || event.mozMovementX || event.webkitMovementX || 0;
    mouseY =
      event.movementY * 0.5 || event.mozMovementY || event.webkitMovementY || 0;
  }
  ...
  return (
    <div className="Hero-Container">
      <div className="Hero">
        <h1>
          Stwórz Swoją<br></br>Klawiaturę
        </h1>
        <div className="container">
          <div className="row Hero-info">
            Witaj na stronie naszego sklepu, gdzie znajdziesz najwyższej jakości
            klawiatury, które możesz spersonalizować według swoich upodobań i
            potrzeb. Nasze produkty są stworzone z myślą o najbardziej
            wymagających klientach, którzy oczekują nie tylko wysokiej jakości,
            ale również unikalnego designu. Nie czekaj i już teraz zacznij
            projektować swoją własną klawiaturę, która będzie wyróżniać Cię
            spośród innych użytkowników.
          </div>
