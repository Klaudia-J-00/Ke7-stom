...
function About() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setKeyboardCount((prevCount) =>
        Math.min(prevCount + 2, maxCount.keyboard)
      );
      setUserCount((prevCount) => Math.min(prevCount + 2, maxCount.user));
      setPersonalizedCount((prevCount) =>
        Math.min(prevCount + 2, maxCount.personalized)
      );
    }, 20);
            ...
            >
              {hoveredIndex === 4 ? (
                <div className="Services m-4">
                  <p>
                    Nasze usługi obejmują projektowanie, drukowanie 3D, montaż,
                    testowanie jakości, a także serwis i naprawę.
                  </p>
                </div>
              ) : (
                <p>USŁUGI</p>
          ...
          >
            {hoveredIndex === 6 ? (
              <div className="About-History row">
                <p className="history">
                  <h4>2019</h4>
                  Grupa przyjaciół, którzy mieli pasję do technologii,
                  postanowiła połączyć siły.
                  <h4>2020</h4>
                  Po wielu testach i prototypach, wydrukowaliśmy pierwszy model
                  klawiatury.
                  <h4>2021</h4>W końcu udało nam się stworzyć klawiaturę
                  idealną, spełniającą wszystkie założenia.
                  <h4>2022</h4>
                  Rozszerzyliśmy naszą ofertę o klawiatury dostosowane do
              ...
              <div className="row">
                ...
                <div className="col-12">
                  <Player
                    src="https://lottie.host/95049bdc-a998-46e9-a83d-414132f0a70d/eceqIG03be.json"
                    loop
                    autoplay
            ...
            {hoveredIndex === 7 ? (
              <div className="About-Stats row">
                <div className="Stats col-12 my-2">
                  ...
                  <p>
                    <h4>{keyboardCount}</h4> sprzedanych klawiatur
                  </p>
                </div>
                <div className="Stats col-12 my-2">
                  <FontAwesomeIcon icon={faWandMagicSparkles} size="2x" />
                  <p>
                    <h4>{personalizedCount}</h4> spersonalizowanych klawiatur{" "}
                  </p>
                </div>
                <div className="Stats col-12 my-2">
                  <FontAwesomeIcon icon={faUsers} size="2x" />
                  <p>
                    <h4>{userCount}</h4> usatysfakcjonowanych klientów
                  </p>
                </div>
              </div>
            ) : (
              <div className="row">
                ...
                <div className="col-12 stats">
                  <Player
                    src="https://lottie.host/1a2b65db-dffc-47ff-97c2-ca88ee2365d3/9OkOwQhSzY.json"
                    loop
                    autoplay
